...
//    @ApiOperation(value = "설문조사 정보 조회" , notes = "설문조사 id를 이용해서 설문조사 정보를 불러온다. (마이페이지 / 설문조사 정보보기)")
    public SurveyQuestionDto getSurveyInfoBySurveyId(@PathVariable Long surveyId){
