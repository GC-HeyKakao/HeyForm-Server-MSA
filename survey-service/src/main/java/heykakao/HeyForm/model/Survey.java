...
//    private Timestamp endtime;
    ...
    public Survey(Integer state, String url, Long user_id, String starttime, String endtime, String category, String description, String surveytitle) {
        this.state = state;
        this.url = url;
    ...
    public void setByDto(SurveyDto surveyDto, Long user_id) {
        this.id = surveyDto.getSurvey_id();
        this.state = surveyDto.getSurvey_state();
        this.url = surveyDto.getSurvey_url();
        this.starttime = surveyDto.getStart_time();
